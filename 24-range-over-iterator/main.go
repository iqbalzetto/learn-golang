...
// convention (but the name can be arbitrary). It will call yield for every element
// we want to iterate over, and note yield's return value for a potential early termination
...
// Here's a function returning an iterator over fibonacci numbers: it keeps running as long
// as yields keeps returning true.
